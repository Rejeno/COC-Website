      ...
      <div className="relative w-full overflow-hidden rounded-[38px] aspect-[4/3] lg:aspect-[2/1] group">
        ...
        {images.map((imgData, index) => (
          ...
          >
            ...
            {/* Caption Overlay */}
            {imgData.caption && (
              <div className="absolute bottom-0 left-0 w-full bg-gradient-to-t from-black via-black/85 to-transparent pt-20 pb-14 lg:pb-16 px-6 md:px-16 text-center">
                <p className="carousel-caption text-white italic font-light drop-shadow-md">
                  {imgData.caption}
                </p>
              </div>
            )}
