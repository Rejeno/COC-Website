...
export default function ArticlePage() {
  ...
  const article = {
    ...
    content: `Coffee has always been more than just a drink, it’s a way of bringing people together. After working as a barista for other cafés, Russel Lujan opened his own cafe in March 2023, The Coffee Studio. The café is run by his family, including his dad, Nereo Cajilig Lujan.

    The name itself hints at what awaits inside. Coffee Studio is not only a place to sip your favorite brew, but it’s a creative space where coffee, photography, music, and stories converge. Vintage cameras line the shelves, vinyl records spin their timeless tunes, and books add character to every corner. The café feels part museum, part sanctuary, inviting guests to slow down and reconnect with the arts while enjoying a cup of locally sourced coffee.

    At the heart of Coffee Studio’s identity is its commitment to supporting local growers. By  sourcing beans from nearby farms, the café strengthens Iloilo’s coffee culture while giving farmers a platform to share their craft. Located near schools and universities, the café quickly became a favorite hangout for students, professionals, and families. The free internet and a welcoming atmosphere make it a practical space, but what keeps people coming back is the feeling it offers.

    The cafe lets you step into nostalgia, surrounded by reminders of art, photography, and music. While waiting for your cup of coffee, the aroma of freshly brewed coffee mingling with the warmth of vinyl records, you can glance at the shelves. You can also appreciate the collection of cameras that once captured moments and the quiet stories held by it. Every detail invites you to pause, reflect, and appreciate the beauty of both coffee and culture.

    With its warm ambiance and the genuine smiles of its staff, Iloilo Coffee Studio is a perfect place for you to enjoy your alone time or with your friends. Whether you’re drawn by a love for the arts, culture, memory, or simply the comfort of a good cup of coffee, the space gently reminds you to slow down. Because in a world that constantly rushes forward, Coffee Studio invites you to breathe, reflect, and appreciate the little things around you that often matter most.`,
  };
