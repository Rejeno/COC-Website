...
export default function ArticlePage() {
  const article = {
    ...
    inlineImage: '/Palpitate/4.jpg',
    author: 'Kelley Marie Matoy ',
    role: 'Article Author',
    avatar: '/Authors/kelley.jpg',
              ...
              <div className="space-y-8">
                ...
                <Link href="/news/city-proper/coffee-studio" className="group block cursor-pointer">
                  ...
                  <p className="mt-2 text-sm text-brand-gray line-clamp-2">
                    With its warm ambiance and the genuine smiles of its staff, Iloilo Coffee Studio is a perfect place...
                  </p>
