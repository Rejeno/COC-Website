          ...
          ">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href=" https://www.instagram.com/sparemewhatyouthink?igsh=dGo0MHRqcWxlMmw4" aria-label="Instagram" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <a href="https://www.linkedin.com/in/trixie-aurelia-ningas-8150253b3?utm_source=share_via&utm_content=profile&utm_medium=member_android" aria-label="LinkedIn" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          ">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href=" https://www.instagram.com/sleigh.mandado?igsh=aHAwaWE1ZDdpd2pr" aria-label="Instagram" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                ...
                <a href="https://www.linkedin.com/in/leigh-diane-mandado-5baa213b2?utm_source=share_via&utm_content=profile&utm_medium=member_android" aria-label="LinkedIn" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/>
                    <rect width="4" height="12" x="2" y="9"/>
                    <circle cx="4" cy="4" r="2"/>
          ...
          ">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href=" https://www.instagram.com/kelseymriee?igsh=MWg0bnUwNHFpZDM1bA==" aria-label="Instagram" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                ...
                <a href="https://www.linkedin.com/in/kelley-marie-matoy-542a4a3a6?utm_source=share_via&utm_content=profile&utm_medium=member_android" aria-label="LinkedIn" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/>
                    <rect width="4" height="12" x="2" y="9"/>
                    <circle cx="4" cy="4" r="2"/>
          ...
          ">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href="https://www.instagram.com/rejenoh?igsh=aWNzaHBiOHlvMGxn" aria-label="Instagram" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                ...
                <a href="https://www.linkedin.com/in/regino-balogojr-24b64136b/" aria-label="LinkedIn" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/>
                    <rect width="4" height="12" x="2" y="9"/>
                    <circle cx="4" cy="4" r="2"/>
          ...
          ">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href="https://www.instagram.com/markndrei/" aria-label="Instagram" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                ...
                <a href="https://www.linkedin.com/in/mark-andrei-encanto-962179351/" aria-label="LinkedIn" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/>
                    <rect width="4" height="12" x="2" y="9"/>
                    <circle cx="4" cy="4" r="2"/>
          ...
          ">
            ...
            <div className="p-6 lg:p-8">
              ...
              <div className="mt-6 flex gap-4">
                ...
                <a href="https://www.instagram.com/rhazeljay/" aria-label="Instagram" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <rect width="20" height="20" x="2" y="2" rx="5" ry="5"/>
                    <path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/>
                    <line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/>
                ...
                <a href="https://www.linkedin.com/in/rhazel-jay-gumacal-365ba2389/" aria-label="LinkedIn" className="text-brand-dark hover:text-brand-green transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                    <path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/>
                    <rect width="4" height="12" x="2" y="9"/>
                    <circle cx="4" cy="4" r="2"/>
