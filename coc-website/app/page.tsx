        ...
        <div className="w-full px-4 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          <div className="md:col-span-8 flex flex-col gap-8">
            <div className={`${montserrat.className} space-y-10 text-sm md:text-lg text-black text-justify font-normal leading-relaxed px-3 md:px-8`}>
              ...
              <p>Iloilo’s coffee history dates back to the post-war era, when its distinct coffee identity took shape through public market venues. One of the oldest coffee shops in Iloilo is the Madge Cafe which was established in the 1940s inside La Paz Public Market. Beloved by the Ilonggo community, then and now, Madge Cafe contributed significantly to Iloilo’s coffee heritage for its traditional brews of robust flavor profiles. Another early coffee establishment is Glory’s Cafe, founded in 1948 and took up space in the Iloilo Central Market area, serving traditional brewing of local barako-style coffee. </p>
